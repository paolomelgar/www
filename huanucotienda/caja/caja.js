    ...
    if(e.which == 13) {
      ...
      if($('#id').val()>0){
        var next= "<tr class='fila'>\n" +
                  "<td width='2%' style='padding:0px;' title='s'><img src='https://raw.githubusercontent.com/paolomelgar/www/master/huanucotienda/fotos/producto/a"+$("#id").val()+".jpg?timestamp=23124' width='100%' height='100%' class='img'></td>\n"+
        ...
        switch(comprobante){
          ...
          case 'FACTURA':
            if(parseInt(data[0].length)<15){
              $('#dx').append("<table width='100%' style='margin-top:160px;font:0.8em Verdana;'><tr><td width='9%'>.</td><td width='91%'>"+data[1][12]+"</td></tr></table>\n"+
          ...
          
          case 'PROFORMA':
            $('#dx').append("<table width='80%' style='margin-top:40px;font:0.9em Calibri;'><tr><td width='7%'>&nbsp</td><td width='73%'>"+data[1][1]+"</td><td width='20%'>"+data[1][12]+"</td></tr></table>\n"+
          ...
          case 'GUIA DE REMISION':
            ...
            $('#dx').append("<div id='xd' align='center'><table width='100%' style='margin-top:125px;font:0.8em Verdana;'><tr><td width='10%'>&nbsp</td><td width='10%'>"+data[1][12]+"</td><td width='20%'>&nbsp</td><td width='10%'>"+data[1][12]+"</td><td width='50%'>&nbsp</td></tr></table>\n"+
              "<table width='100%' style='margin-top:12px;font:0.8em Verdana;'><tr><td width='3%'>&nbsp</td><td width='40%' align='center'>JR. huanucotienda N° 959</td><td width='10%'>&nbsp</td><td width='47%' align='center'>"+arr[0]+"</td></tr></table>\n"+
              "<table width='100%' style='margin-top:-3px;font:0.8em Verdana;'><tr><td width='4%'>&nbsp</td><td width='11%'>huanucotienda</td><td width='5%'>&nbsp</td><td width='11%'>huanucotienda</td><td width='5%'>&nbsp</td><td width='11%'>huanucotienda</td><td width='10%'>&nbsp</td><td width='15%'>"+arr[3]+"</td><td width='1%'>&nbsp</td><td width='11%'>"+arr[2]+"</td><td width='5%'>&nbsp</td><td width='16%'>"+arr[1]+"</td></tr></table>\n"+
  ...
  $('#estado').on('click',function(e){
    if(e.offsetY < 0){
      if($('#id1').val()>0 && $('#estado').val()!=""){
        $('#row1').append(
          "<tr class='fila'>\n" +
          "  <td width='2%' style='padding:0px;' title='s'><img src='https://raw.githubusercontent.com/paolomelgar/www/master/huanucotienda/fotos/producto/a"+$("#id1").val()+".jpg?timestamp=23124' width='100%' height='100%'></td>\n"+
          ...
          click: function() { 
            $.ajax({
              ...
              success: function(data){
                ...
                for (var i=0;i<data[0].length;i++) {
                  var next= "<tr class='fila'>\n" +
                            "<td width='2%' style='padding:0px;' title='s'><img src='https://raw.githubusercontent.com/paolomelgar/www/master/huanucotienda/fotos/producto/a"+data[0][i][4]+".jpg?timestamp=23124' width='100%' height='100%'></td>\n"+
                ...
                for (var i=0;i<data[2].length;i++) {
                  ...
                  $('#row1').append(
                    "<tr class='fila'>\n" +
                    "<td width='2%' style='padding:0px;' title='s'><img src='https://raw.githubusercontent.com/paolomelgar/www/master/huanucotienda/fotos/producto/a"+data[2][i][4]+".jpg?timestamp=23124' width='100%' height='100%'></td>\n"+
          ...
          switch($('#documento').val()){
            ...
            case 'GUIA DE REMISION':
              ...
              $(this).append("<div id='xd' align='center'><table width='100%' style='margin-top:0px;font:1.0em Verdana;'><tr><td width='10%'>&nbsp</td><td width='10%'>"+$('#fecha').val()+"</td><td width='20%'>&nbsp</td><td width='10%'>"+$('#fecha').val()+"</td><td width='50%'>&nbsp</td></tr></table>\n"+
                "<table width='100%' style='margin-top:7px;font:1.0em Verdana;'><tr><td width='3%'>&nbsp</td><td width='40%' align='center'>JR. huanucotienda N° 959</td><td width='10%'>&nbsp</td><td width='47%' align='center'>"+arr[0]+"</td></tr></table>\n"+
                "<table width='100%' style='margin-top:-3px;font:1.0em Verdana;'><tr><td width='5%'>&nbsp</td><td width='10%'>huanucotienda</td><td width='5%'>&nbsp</td><td width='10%'>huanucotienda</td><td width='5%'>&nbsp</td><td width='10%'>huanucotienda</td><td width='15%'>&nbsp</td><td width='10%'>"+arr[3]+"</td><td width='5%'>&nbsp</td><td width='10%'>"+arr[2]+"</td><td width='5%'>&nbsp</td><td width='10%'>"+arr[1]+"</td></tr></table>\n"+
