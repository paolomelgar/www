...
<body>
	<div style='display:none' id="agregardatos">
		<form name="formagregar" id="formagregar">
			<table width='100%'>
				...
				<tr><td width='25%'>CATEGORIA:</td><td qidth='75%'><input type="text" name="familia" id="familia" class="span3" style="text-transform:uppercase;float:left;"/></td></tr>
				<tr><td width='25%'>ACTIVO:</td><td qidth='75%'><select id="activo1" name="activo1" class="span3">
	...
	<div id="body">
		<h3 style="text-align: center;color:#428bca;margin-top:-2px;font-weight:bold">REGISTRO DE CATEGORIAS</h3>
		<div id="boton">
			FAMILIA:<input type="text" id="busqueda" name="busqueda" class="span6" placeholder="Realize su Busqueda..." style="text-transform:uppercase;margin-right:10px" autocomplete="off"/>
		...
		<table class="table table-bordered">
			<thead>
				<tr style='background-color:#428bca;color:white'>
					<th style="text-align: center;width:2.5%">IMAGEN</th>
					<th style="text-align: center;width:87.5%">CATEGORIA</th>
	      	...
	      	<tfoot id='foot'>
		        <tr>
		          <td colspan='14'>
		            ...
		            <div style="float:right;margin-top:5px;">Total de Categorias Registrados:   </div>
		          </td>
		        <tr>
		    </tfoot>
		</table> 
