...
<form id="form" action="" method="post">
  <table width='100%' style='border-collapse:collapse'>
    <tr><td colspan='9' align='center' style='font-size:22px;font-weight:bold;background-color:#28ABDD;color:white'>KARDEX DE PROVEEDORES</td></tr>
    <tr style='height:35px;background-color:#E0ECF8'>
      <td style='text-align:right'>PROVEEDOR:</td>
      <td><input type='text' id='proveedor' name='proveedor' size='40'></td>
      ...
      <td style='text-align:right'>COMPRA:</td>
      <td>
        <select id='change' name='change'>
          <option value"REAL">REAL</option>
          <option value"CONTABLE PAOLA">CONTABLE PAOLA</option>
          <option value"CONTABLE DORIS">CONTABLE DORIS</option>
        </select>
      </td>
