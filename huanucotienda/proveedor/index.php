...
<?php 
session_start();
if($_SESSION['valida']=='huanucotienda' && $_SESSION['cargo']=='ADMIN' || $_SESSION['cargo']=='CAJERO'){
?>
<html>
<head>
...
<body>
	...
	<form name="formagregar" id="formagregar">
		<table width='100%'>
			...
			<tr><td width='25%'>PROVEEDOR:</td><td width='75%'><input type="text" name="proveedor" id="proveedor" class="span3" style="text-transform:uppercase;float:left;"/></td></tr>
			...
			<tr><td width='25%'>REPRESENT:</td><td width='75%'><input type="text" name="representante" id="representante" class="span3" style="text-transform:uppercase;float:left;"/></td></tr>
			<tr><td width='25%'>TELEFONO:</td><td width='75%'><input type="text" name="telefono" id="telefono" maxlength='10' class="span3" style="text-transform:uppercase;float:left;"/></td></tr>
			<tr><td width='25%'>CELULAR:</td><td width='75%'><input type="text" name="celular" id="celular" maxlength='10' class="span3" style="text-transform:uppercase;float:left;"/></td></tr>
			<tr><td width='25%'>CUENTA:</td><td width='75%'><input type="text" name="mail" id="mail" class="span3" style="text-transform:uppercase;float:left;"/></td></tr>
