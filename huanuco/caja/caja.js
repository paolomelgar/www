          ...
          case 'FACTURA':
            if(parseInt(data[0].length)<15){
              ...
              $("#dx").append("<table width='100%' style='font:0.8em Verdana;margin-top:0px;'><tr><td width='4%'></td><td width='76%' id='let'></td><td width='10%'>&nbsp</td><td align='right' width='10%'>"+subigv1+"</td></tr></table>\n"+
                ...
                "<table width='100%' style='margin-top:6px;font:0.8em Verdana;'><tr><td width='55%'>.</td><td width='6%'>"+data[1][12].slice(0,2)+"</td><td width='6%'>"+data[1][12].slice(3,5)+"</td><td width='6%'>"+data[1][12].slice(6,10)+"</td><td width='17%' style='font-size:12px'></td><td align='right' width='10%'>"+data[1][3]+"</td></tr></table>");
              $.ajax({
                type: "POST",
