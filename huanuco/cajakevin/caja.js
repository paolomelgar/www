...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var stock,compra,promotor,unit,minimo;
      ...
      $.ajax({
        ...
        success: function(data){
          ...
          $('#tb1 tr').click(function(){
            ...
            stock=parseFloat($('#tb1>tr:eq('+x+')').find('td:eq(4)').text());
            compra=parseFloat($('#tb1>tr:eq('+x+')').find('td:eq(7)').text());
            promotor=parseFloat($('#tb1>tr:eq('+x+')').find('td:eq(5)').text()).toFixed(2);
            unit=parseFloat($('#tb1>tr:eq('+x+')').find('td:eq(5)').text()).toFixed(2);
            if($('#cargo').val()=='ADMIN'){
              minimo=parseFloat($('#tb1>tr:eq('+x+')').find('td:eq(7)').text()).toFixed(2);
            }else{
              minimo=parseFloat($('#tb1>tr:eq('+x+')').find('td:eq(6)').text()).toFixed(2);
            }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  $('#precio_u').keyup(function(e){
    ...
    $(this).blur(function(){
      ...
      else if (unit<promotor && unit>=minimo) {
        $('#precio_u').val(unit);
    ...
    if(e.which == 13) {
      ...
      if($('#id').val()>0){
        var next= "<tr class='fila'>\n" +
                  "<td width='2%' style='padding:0px;' title='s'><img src='../fotos/a"+$("#id").val()+".jpg?timestamp=23124' width='100%' height='100%' class='img'></td>\n"+
        ...
        if($('#cantidad').hasClass('mayorstock')){
          ...
          next += "<td width='10%' style='text-align:right'>" + parseFloat($("#importe").val()).toFixed(2) + "</td>\n" +
                  ...
                  "<td style='display:none'>" + minimo +"</td>\n" +
                  "</tr>";
        $('#cantidad').removeClass('mayorstock');
        $('#precio_u').removeClass('mayorstock');
        $('#row').append(next);
      ...
      success: function(data){
        ...
        switch(comprobante){
          case 'BOLETA DE VENTA':
            $('#dx').append("<table width='80%' style='margin-top:47px;margin-left:8px;font:0.8em Calibri;'><tr><td width='100%'>Fecha: "+data[1][12]+"</td></tr></table>\n"+
              "<table width='80%' style='margin-top:-8px;margin-left:8px;font:0.8em Calibri;'><tr><td width='100%'>"+data[1][1]+"</td></tr></table>\n"+
              "<table width='80%' style='margin-top:-8px;margin-left:8px;font:0.8em Calibri;'><tr><td width='100%'>"+data[1][2]+"</td></tr></table>\n"+
              "<table width='80%' style='margin-bottom:2px;margin-top:-5px'><tr><td width='5%' align='center'>&nbsp</td><td width='75%' align='center'></td><td width='10%' align='center'></td><td width='10%' align='center'></td></tr></table>\n"
            );
            for (var i=0;i<data[0].length;i++) {
              $('#dx').append("<table width='75%' style='margin-top:-8px;font:0.7em Verdana;margin-left:15px;'><tr height='17px'><td width='7%' align='right'>"+data[0][i][1]+"&nbsp&nbsp&nbsp</td><td width='63%'>"+data[0][i][0]+"</td><td width='15%' align='right'>"+data[0][i][2]+"</td><td width='15%' align='right'>"+data[0][i][3]+"</td></tr></table>");
            }
            while(v1<16-parseInt(data[0].length)){
              $('#dx').append("<table width='75%' style='margin-top:-8px;font:0.7em Verdana;'><tr height='15px'><td>&nbsp</td></tr></table>");
              v1++;
            }
            $('#dx').append("<table width='75%' style='font:0.8em Verdana;font-weight:bold;margin-top:6px;margin-left:15px;'><tr><td width='90%' align='right'>&nbsp</td><td align='right' width='10%'>"+data[1][3]+"</td></tr></table></div>");
          ...
          
          case 'FACTURA':
            $('#dx').append("<table width='100%' style='margin-top:128px;font:0.8em Verdana;'><tr><td width='12%'>&nbsp</td><td width='88%'>"+data[1][1]+"</td></tr></table>\n"+
              "<table width='100%' style='margin-top:3px;font:0.7em Verdana;'><tr><td width='12%'>&nbsp</td><td width='89%'>"+data[1][2]+"</td></tr></table>\n"+
              "<table width='100%' style='margin-top:1px;font:0.7em Verdana;'><tr><td width='12%'>&nbsp</td><td width='76%'>"+data[1][0]+"</td><td width='12%' align='right'>"+data[1][12]+"</td></tr></table>\n"+
            ...
            for (var i=0;i<data[0].length;i++) {
              $('#dx').append("<table width='100%' style='margin-top:-5px;font:0.7em Verdana;'><tr height='18px'><td width='8%' align='right'>"+data[0][i][1]+"</td><td width='10%' align='center'>UND</td><td width='62%'>"+data[0][i][0]+"</td><td width='10%' align='right'>"+data[0][i][2]+"</td><td width='10%' align='right'>"+data[0][i][3]+"</td></tr></table>");
            }
            while(v1<14-parseInt(data[0].length)){
            ...
            if(data[1][15]>0){
              ...
              igv1=parseFloat(0).toFixed(2);
            }
            $("#dx").append("<table width='100%' style='font:0.8em Verdana;margin-top:2px;'><tr><td width='7%'></td><td width='73%' id='let'></td><td width='10%'>&nbsp</td><td align='right' width='10%'>"+subigv1+"</td></tr></table>\n"+
              "<table width='100%' style='margin-top:2px;font:0.8em Verdana'><tr><td width='80%'></td><td width='10%' style='font-size:12px' align='center'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td align='right' width='10%'>"+igv1+"</td></tr></table>\n"+
              "<table width='100%' style='margin-top:2px;font:0.8em Verdana'><tr><td width='59%'></td><td width='6%'>&nbsp</td><td width='6%'>&nbsp</td><td width='6%'>&nbsp</td><td width='13%' style='font-size:12px'></td><td align='right' width='10%'>"+data[1][3]+"</td></tr></table>");
            $.ajax({
              type: "POST",
          ...
          
          case 'PROFORMA':
            $('#dx').append("<table width='80%' style='margin-top:35px;font:0.9em Calibri;'><tr><td width='7%'>&nbsp</td><td width='73%'>"+data[1][1]+"</td><td width='20%'>"+data[1][12]+"</td></tr></table>\n"+
            ...
            $('#dx').append("<table width='77%' style='font:0.7em Verdana;font-weight:bold;margin-top:2px'><tr><td width='90%' align='right'>&nbsp</td><td align='right' width='10%'>"+data[1][3]+"</td></tr></table></div>");
            contenid = document.getElementById("dx");
            w.document.write("<html><head><style type='text/css'>@page{size:A4 portrait;}</style></head><body>"+contenid.innerHTML+"</body></html>");
          break;
          
          case 'NOTA DE PEDIDO':
            $('#dx').append("<table width='70%' style='font:1.1em Verdana;'><tr><td align='center'><b>FERRETERIA KEVIN</b></td></tr></table>\n"+
              "<table width='70%' style='font:0.8em Verdana;margin-top:-8px'><tr><td><span style='margin-left:165px'><b>NOTA DE PEDIDO</b></span><span style='float:right;font-family:Calibri'>Celular: 943531542</span></td></tr></table>\n"+
              "<table width='70%' style='margin-top:-7px;font:0.8em Calibri;'><tr><td width='10%'>RUC:</td><td width='55%'>"+data[1][0]+"</td><td width='10%'>Fecha:</td><td width='25%'>"+data[1][12]+"</td></tr></table>\n"+
              "<table width='70%' style='margin-top:-7px;font:0.8em Calibri;'><tr><td width='10%'>CLIENTE:</td><td width='55%'>"+data[1][1]+"</td><td width='10%'>Vendedor:</td><td width='25%'>"+data[1][6]+"</td></tr></table>\n"+
              "<table width='70%' style='margin-top:-7px;font:0.8em Calibri;'><tr><td width='10%'>DIRECCION:</td><td width=100%' style='font-family:Agency FB'>"+data[1][2]+"</td></tr></table>\n"+
              "<table width='70%' style='margin-bottom:5px;margin-top:0px;font:0.7em Verdana;font-weight:bold;border-collapse:collapse'><tr style='border:1px solid black'><td width='2%'></td><td width='5%' align='center'>CAN</td><td width='73%' align='center'>PRODUCTO</td><td width='10%' align='center'>P.UNITARIO</td><td width='10%' align='center'>IMPORTE</td></tr></table>\n"
            );
            for (var i=0;i<data[0].length;i++) {
              $('#dx').append("<table width='70%' style='margin-top:-6px;font:0.7em Verdana;'><tr><td width='2%' align='center'><input style='width:10px;height:10px;border:1px solid black'></td><td width='5%' align='right'>"+data[0][i][1]+"</td><td width='1%'></td><td width='72%'>"+data[0][i][0]+"</td><td width='10%' align='right'>"+data[0][i][2]+"</td><td width='10%' align='right'>"+data[0][i][3]+"</td></tr></table>");
            }
            if(parseFloat(data[1][4])!=0){
              $('#dx').append("<table width='70%' style='margin-top:-5px;margin-bottom:5px;font:0.7em Verdana;'><tr><td colspan='4' width='90%' align='right'>SUBTOTAL</td><td width='10%' align='right'>"+data[1][3]+"</td></tr></table><hr style='margin-top:-6px'>");
              for (var i=0;i<data[2].length;i++) {
                $('#dx').append("<table width='70%' style='margin-top:-6px;font:0.7em Verdana;'><tr><td width='5%' align='right'>"+data[2][i][1]+"&nbsp&nbsp</td><td width='75%'>"+data[2][i][0]+"</td><td width='10%' align='right'>"+data[2][i][2]+"</td><td width='10%' align='right'>"+data[2][i][3]+"</td></tr></table>");
              }
              $('#dx').append("<table width='70%' style='margin-top:-5px;font:0.7em Verdana;'><tr><td colspan='4' width='90%' align='right'>DEVOLUCION</td><td align='right'>"+data[1][4]+"</td></tr></table>");
            }
            $('#dx').append("<table width='70%' style='margin-top:-5px;font:0.7em Verdana;'><tr><td colspan='4' width='90%' align='right'>TOTAL</td><td align='right'>"+data[1][5]+"</td></tr></table>");
            if(data[1][10]>0){
              $('#dx').append("<table width='70%' style='margin-top:-5px;font:0.7em Verdana;' ><tr><td colspan='4' width='90%' align='right'>A/C.</td><td align='right'>"+data[1][10]+"</td></tr></table>");
              var resta1=parseFloat(data[1][5]-data[1][10]).toFixed(2);
              $('#dx').append("<table width='70%' style='margin-top:-5px;font:0.7em Verdana;'><tr><td colspan='4' width='90%' align='right'>RESTA</td><td align='right'>"+resta1+"</td></tr></table></div>");
            }
            if(data[1][7]!=''){
              $('#dx').append("<table width='70%' style='margin-top:1px'><tr><td style='font:0.8em Verdana' width='5%'>OBS:</td><td style='font:0.9em Verdana;font-weight:bold'>"+data[1][7]+"</td></tr></table></div>");
            }
            $('#dx').append("<table width='70%' style='margin-top:1px'><tr><td style='font:1.0em Verdana;font-weight:bold' width='5%' align='center'>"+data[1][9]+"</td></tr></table></div>");
            contenid = document.getElementById("dx");
            w.document.write("<html><head><style type='text/css'>@page{size:A4 portrait;}</style></head><body>"+contenid.innerHTML+"</body></html>");
          break;
          
          case 'GUIA DE REMISION':
            $('#dx').append("<div id='xd' align='center'><table width='100%' style='margin-top:112px;font:0.8em Verdana;'><tr><td width='12%'>&nbsp</td><td width='10%'>"+data[1][12]+"</td><td width='28%'>&nbsp</td><td width='10%'>"+data[1][12]+"</td><td width='40%'>&nbsp</td></tr></table>\n"+
              "<table width='100%' style='margin-top:28px;font:0.7em Verdana;'><tr><td width='7%'>&nbsp</td><td width='47%' align='center'>CAR. CARRET. CENTRAL KM 7.5 CPME. YANAG ROSAVERO - HUANUCO - HUANUCO - PILLCOMARCA</td><td width='8%'>&nbsp</td><td width='38%' align='center'>"+data[1][2]+"</td></tr></table>\n"+
              "<table width='100%' style='margin-top:20px;font:0.7em Verdana;'><tr><td width='7%'>&nbsp</td><td width='93%'>"+data[1][1]+"</td></tr></table>\n"+
              "<table width='100%' style='margin-top:-2px;font:0.7em Verdana;'><tr><td width='7%'>&nbsp</td><td width='93%'>"+data[1][0]+"</td></tr></table>\n"+
              "<table width='100%' style='margin-bottom:32px;margin-top:0px'><tr><td width='5%' align='center'>&nbsp</td><td width='75%' align='center'>&nbsp</td><td width='10%' align='center'>&nbsp</td><td width='10%' align='center'>&nbsp</td></tr></table>\n"
            );
            for (var i=0;i<data[0].length;i++) {
              $('#dx').append("<table width='100%' style='margin-top:-8px;font:0.7em Verdana;'><tr height='18px'><td width='12%'>&nbsp</td><td width='54%'>"+data[0][i][0]+"</td><td width='16%' align='right'>"+data[0][i][1]+"</td><td width='18%'>&nbsp</td></tr></table>");
            }
            contenid = document.getElementById("dx");
            w.document.write("<html><head><style type='text/css'>@page{size:A4 portrait;}</style></head><body>"+contenid.innerHTML+"</body></html>");
          break;
          
          case 'COTIZACION':
            $('#dx').append('<div align="center"><div style="color:black;font-weight:bold;font-size:30px;font-family:Georgia;margin-bottom:20px">FERRETERIA "KEVIN"</div></div>\n'+
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  $('#row').on('keyup','.editme2',function(){
    if(parseFloat($(this).text())>=parseFloat($(this).parent().find('td:eq(9)').text())){
      $(this).parent().find('td:eq(4)').text(parseFloat($(this).parent().find('td:eq(2)').text())*parseFloat($(this).text()));
    }
    else{
      $(this).parent().find('td:eq(4)').text(parseFloat($(this).parent().find('td:eq(2)').text())*parseFloat($(this).parent().find('td:eq(9)').text()));
    }
  ...
  $('#estado').on('click',function(e){
    if(e.offsetY < 0){
      if($('#id1').val()>0 && $('#estado').val()!=""){
        $('#row1').append(
          "<tr class='fila'>\n" +
          "  <td width='2%' style='padding:0px;' title='s'><img src='../fotos/a"+$("#id1").val()+".jpg?timestamp=23124' width='100%' height='100%'></td>\n"+
  ...
  $('#dialogver').on('click','.visualizar',function(){
    ...
    if($(this).parent().find('td:eq(6)').text()=='CONTADO'){
      if($(this).parent().find('td:eq(3)').text().slice(0,10)!=fech){
        ...
        if($(this).parent().find('td:eq(7)').text()=='ANULADO' || $('#cargo').val()=='CAJERO TIENDA' || $('#cargo').val()=='CAJERO FIERROS'){
          $(".ui-dialog-buttonpane button:contains('ELIMINAR')").button("disable");
      ...
      if($(this).parent().find('td:eq(3)').text().slice(0,10)!=fech && $('#cargo').val()=='CAJERO' || $('#cargo').val()=='CAJERO FIERROS'){
        $(".ui-dialog-buttonpane button:contains('ELIMINAR')").button("disable");
        $(".ui-dialog-buttonpane button:contains('EDITAR')").button("disable");
      }else{
        if($(this).parent().find('td:eq(7)').text()=='ANULADO' || $('#cargo').val()=='CAJERO' || $('#cargo').val()=='CAJERO FIERROS'){
          $(".ui-dialog-buttonpane button:contains('ELIMINAR')").button("disable");
          $(".ui-dialog-buttonpane button:contains('EDITAR')").button("enable");
        }else{
          $(".ui-dialog-buttonpane button:contains('ELIMINAR')").button("enable");
          ...
          click: function() { 
            $.ajax({
              ...
              success: function(data){
                ...
                for (var i=0;i<data[0].length;i++) {
                  var next= "<tr class='fila'>\n" +
                            "<td width='2%' style='padding:0px;' title='s'><img src='../fotos/a"+data[0][i][4]+".jpg?timestamp=23124' width='100%' height='100%'></td>\n"+
                ...
                for (var i=0;i<data[2].length;i++) {
                  ...
                  $('#row1').append(
                    "<tr class='fila'>\n" +
                    "<td width='2%' style='padding:0px;' title='s'><img src='../fotos/a"+data[2][i][4]+".jpg?timestamp=23124' width='100%' height='100%'></td>\n"+
      ...
      $("#procesarenvio").dialog({
        ...
        open: function() {
          ...
          switch($('#documento').val()){
            ...
            
            case 'COTIZACION':
              $(this).append('<div id="xd"><div align="center"><div style="color:black;font-weight:bold;font-size:30px;font-family:Georgia;margin-bottom:20px">FERRETERIA <span style="color:red">"KEVIN"</span></div></div>\n'+
                "<table width='100%'><tr><td align='center' colspan='4'><span align='center'><b>COTIZACION</b></span></tr></table>\n"+
