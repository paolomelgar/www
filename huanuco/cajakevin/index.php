...
<?php 
session_start();
if($_SESSION['valida']=='true' && $_SESSION['cargo']!='VENDEDOR' ){
?>
<html>
<head>
  <title>CAJA</title>
...
<body>
  <form id="form" name="form" action="" method="post" autocomplete="off">
    ...
    <?php if($_SESSION['cargo']!='CAJERO FIERROS'){ ?>
    <a style="position:absolute;left:800px;top:3px;cursor:pointer;" id="mostrarpendientes">
      <img src="boom.png" style="width:30px;margin-top:2px;margin-left:10px"/>
      <span id="mes"></span>
    </a>
    <?php } ?>
