<?php
  require_once('../connection.php');
    ...
    if($_POST['estado']=='CANCELADO'){
      ...
      $sql=mysqli_query($con,"SELECT * FROM prestamos WHERE $query ORDER BY fecha");
      $n=0;
    ?>
    ...
    <table width='98%' align='center' style='border-collapse:collapse;'>
      <thead>
        <tr bgcolor="black" style="color:white;font-weight:bold;" >
          <th width="10%" style="border: 1px solid white;">N°</th>
          <th width="10%" style="border: 1px solid white;">BANCO</th>
          <th width="20%" style="border: 1px solid white;">DOCUMENTO</th>
          <th width="20%" style="border: 1px solid white;">MONTO</th>
          <th width="20%" style="border: 1px solid white;">FECHA PAGO</th>
          <th width="10%" style="border: 1px solid white;">DIAS</th>
          <th width="10%" style="border: 1px solid white;">COBRAR</th>
        </tr>
      </thead>
    </table>
      ...
      <table width='98%' id="venta" style="border-collapse: collapse;" align='center'>
        ...
        while($row=mysqli_fetch_assoc($sql)){
          ...
          <tr style="font-size:12px;font-weight:bold">
            <td width="10%" style="border: 1px solid black;" align='right'><?php echo $n; ?></td>
            <td width="10%" style="border: 1px solid black;"><?php echo $row['banco']; ?></td>
            <td width="20%" style="border: 1px solid black;" align='center'><?php echo $row['dni']; ?></td>
            <td width="20%" style="border: 1px solid black;background-color:#f63;color:blue;font-size:14px" align='right'><?php echo $row['monto']; ?></td>
            <td width="20%" style="border: 1px solid black;" align='center'><?php echo $row['fecha']; ?></td>
    ...
    <table width='98%' align='center' style="border-collapse: collapse;margin-top:4px">
      <tr>
        <td width='40%' style="border: 1px solid black;text-align:right" colspan='3'>TOTAL</td>
        <td width='20%' style="border: 1px solid black;text-align:right" id='suma'></td>
        <td width='40%' style="border: 1px solid black;text-align:right" colspan='4'></td>
      </tr>
    </table>
