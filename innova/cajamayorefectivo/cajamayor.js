  ...
  function buscar(){
    $.ajax({
      ...
      success: function(data){
        ...
        $('#total').val(parseFloat(parseFloat(data[0])+parseFloat(data[1])+parseFloat(data[2])+parseFloat(data[3])+parseFloat(data[8])-parseFloat(data[4])-parseFloat(data[5])).toFixed(2));
      }
    });
  }
  buscar();
    ...
    function(isConfirm){
      if (isConfirm) {
        $.ajax({
          type: "POST",
          url: "cerrarcaja.php",
          data: 'total='+$('#total').val()+'&real='+$('#real').val()+'&diferencia='+$('#diferencia').val()+'&fecha='+$('#fecha').val(),
          success: function(data){
          }
        });
