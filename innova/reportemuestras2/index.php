...
<html>
<head>
  <title>REPORTE MUESTRAS 2</title>
...
<form id="form" action="" method="post">
  <h3 style='color:white;text-align:center;margin-top:0px;margin-bottom:0px;background-color:#3FED59;font-weight:bold;'>PRODUCTOS EN MUESTRAS 2</h3>
  <table width='100%'>
    <tr bgcolor='#E0F8E6'>
      ...
      <td>
        <select id='estado' name='estado' style='margin-bottom: 0px;' class='span2'>
          <option value="MUESTRAS2">MUESTRAS2</option>
        </select>
      </td>
