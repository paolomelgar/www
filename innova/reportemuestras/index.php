...
<form id="form" action="" method="post">
  <h3 style='color:white;text-align:center;margin-top:0px;margin-bottom:0px;background-color:#3FED59;font-weight:bold;'>PRODUCTOS EN MUESTRAS</h3>
  <table width='100%'>
    <tr bgcolor='#E0F8E6'>
