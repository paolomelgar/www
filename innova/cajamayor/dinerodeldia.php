<?php
  require_once('../connection.php');
    if(isset($_POST) && !empty($_POST)){
      ...
      $resul2=mysqli_query($con,"SELECT * FROM dineromayor WHERE fecha='".date('Y-m-d', strtotime(str_replace('/', '-', $_POST['fecha'])."- 1 days"))."'");
      $resul3=mysqli_query($con,"SELECT * FROM dineromayor WHERE fecha='".date('Y-m-d', strtotime(str_replace('/', '-', $_POST['fecha'])))."'");
