...
if(isset($_POST['accion']) && !empty($_POST['accion'])){
    switch ($_POST['accion']) {
        case 'add':
            ...
            move_uploaded_file($_FILES['imagen']['tmp_name'], realpath("../foto".$_SESSION['mysql']."/marca ")."/a".$ro[0].".jpg");
    	break;
    	...
    	case 'edit':
            ...
            move_uploaded_file($_FILES['imagen']['tmp_name'], realpath("../foto".$_SESSION['mysql']."/marca ")."/a".$_POST['id'].".jpg");
   		break;
