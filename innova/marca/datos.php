...
require_once('../connection.php');
    ...
    while($row=mysqli_fetch_assoc($result)){ ?>  
        <tr class="tr">
            ...
            <td style='padding:0px' align='center' title='a'><?php echo '<img src="https://raw.githubusercontent.com/paolomelgar/www/master/innova/foto'.$_SESSION['mysql'].'/marca/a'.$row['id'].'.jpg?timestamp=41232" height="100%" width="100%">'; ?></td>
