...
<body id='body'>
    <div id="informacion">
      <table width="100%" style='border-collapse:collapse'>
        <tr bgcolor="#FA2D2D">
          <th colspan="7" style="align:center;font-weight:bold;color:white;font-size:22px">PAGOS DE PRESTAMISTAS</th>
        </tr>
        <tr bgcolor='#FFCECE'>
    ...
    <div id='dialog' style='display:none'> 
      <span>TOTAL: <input style='text-align:right' type='text' id='mon' size='12'>&nbsp&nbsp&nbspPRESTAMISTA: <input type='text' id='banco' size='11'></span></br>
