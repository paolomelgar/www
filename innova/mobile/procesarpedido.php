...
require_once('../connection.php');
    ...
    if($_POST['str'][0]['value'] !='' AND $_POST['str'][1]['value']!=''){
        $cons=mysqli_query($con,"SELECT * FROM cliente WHERE ruc='".$_POST['str'][0]['value']."' AND cliente='".$_POST['str'][1]['value']."'");
        if(mysqli_num_rows($cons)==0){
            $cliente= mysqli_query($con,"INSERT INTO cliente (ruc,cliente,direccion,tipo,activo) 
                VALUES ('".$_POST['str'][0]['value']."',
                        '".$_POST['str'][1]['value']."',
                        '".$_POST['str'][2]['value']."',
                        'UNIDAD',
                        'SI')");
