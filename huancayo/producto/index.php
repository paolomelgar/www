...
<body>
  ...
  <form name="formagregar" id="formagregar">
    <table width='100%'>
      ...
      <tr><td>PROVEEDOR:</td><td><input type="text" name="proveedor" id='proveedor' class="span3" style="float:left;"/></td></tr>
    ...
    <table class="table table-bordered">
      <thead>
          <tr style='background-color:#428bca;color:white'>
              <th style="text-align: center;width:2.7%">IMG</th>
              <th style="text-align: center;width:20.3%">PRODUCTO</th>
              <th style="text-align: center;width:9%">MARCA</th>
              ...
              <th style="text-align: center;width:5%">S.CON</th>
              <th style="text-align: center;width:4%"></th>
              <th style="text-align: center;width:6%">P.UNID</th>
              <th style="text-align: center;width:6%">P.PROM</th>
