...
//////////////////////////////////////////////////////////////////////////////////////////////////////////// 
  ...
  $('#dialogver').on('click','.visualizar',function(){
    ...
    doc=$(this).parent().parent().find('td:eq(3)').text();
    if($(this).parent().parent().find('td:eq(6)').text()=='ANULADO'){
        ...
        $.ajax({
          ...
          success: function(data){
            ...
            for (var i=0;i<data[0].length;i++) {
              $('#row').append(
                "<tr class='fila'>\n" +
                "  <td width='2%' style='padding:0px;' title='s'><img src='https://raw.githubusercontent.com/paolomelgar/ferreboom/master/huanuco/producto/a"+data[0][i][4]+".jpg?timestamp=23124' width='100%' height='100%' class='img'></td>\n"+
