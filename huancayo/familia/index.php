...
<?php 
session_start();
if($_SESSION['valida']=='huancayo' && $_SESSION['cargo']=='ADMIN' || $_SESSION['cargo']=='CAJERO'){
?>
<html>
<head>
	...
	<div style='display:none' id="agregardatos">
		<form name="formagregar" id="formagregar">
			<table width='100%'>
				...
				<tr><td>CATEGORIA:</td><td><input type="text" name="familia" id="familia" class="span3" style="text-transform:uppercase;float:left;"/></td></tr>
