...
require_once('../connection.php');
  if(isset($_POST) && !empty($_POST)){
    ...
    $query = "SELECT * FROM producto WHERE $producto AND activo!='NO' AND foto='SI' ORDER BY producto,marca LIMIT 6";
    ...
    ?>
      <tr bgcolor='white' style='border:1px solid grey'>
        <td style='padding:0px;'><?php echo '<img src="https://raw.githubusercontent.com/paolomelgar/ferreboom/master/huanuco/producto/a'.$row['id'].'.jpg?timestamp=23124" width="60px" height="60px">'; ?></td>
