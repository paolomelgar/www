	  ...
	  $(function(){
	          	...
	          	for (var i = 0; i <= data.length-1; i++) {
	          		if(data[i][3]<=0){
	          			d += "<td width='15%' align='center' style='font-size:14px;border:4px solid #FF5566;border-radius:5px;background-color:white;padding:0px' class='aa'>\n"+
	          					...
	          					"<tr><td colspan='2' align='center' class='img' style='cursor:pointer'><img src='https://raw.githubusercontent.com/paolomelgar/ferreboom/master/huancayo/producto/a"+data[i][4]+".jpg' height='200' width='200'><img src='agotado.png' width='200px' style='position:absolute;margin-left:-200px;margin-top:26px;color:red;font-weight:bold;font-size:30px;'/></td></tr>\n";
	          					if(data[i][7]>0){
		          				d += "<tr><td width='100px'><img src='https://raw.githubusercontent.com/paolomelgar/ferreboom/master/huancayo/marca/a"+data[i][7]+".jpg' width='100px'></td><td width='100px' style='font-weight:bold;font-size:25px;color:#f63;' class='precio' align='center'>S/ "+data[i][1]+"</td></tr>\n";
		          			}else{
	          			...
	          			if(data[i][6]=='OFERTA'){
	          				...
	          				if(data[i][9]=="nuevo"){
		          				d += "<td width='15%' align='center' style='font-size:14px;border:4px solid #8E8E8E;border-radius:5px;background-color:white;padding:0px' class='aa'>\n"+
			          					...
			          					"<tr><td colspan='2' align='center' class='img' style='cursor:pointer'><img src='https://raw.githubusercontent.com/paolomelgar/ferreboom/master/huancayo/producto/a"+data[i][4]+".jpg' height='200' width='200'><img src='nuevo.png' width='200px' style='position:absolute;margin-left:-200px;margin-top:0px;color:red;font-weight:bold;font-size:30px;'/></td></tr>\n";
		          			}else{
		          				d += "<td width='15%' align='center' style='font-size:14px;border:4px solid #8E8E8E;border-radius:5px;background-color:white;padding:0px' class='aa'>\n"+
			          					"<table width='100%' height='300px' style='border-collapse:collapse;'>\n"+
			          					"<tr><td colspan='2' align='center' class='img' style='cursor:pointer'><img src='https://raw.githubusercontent.com/paolomelgar/ferreboom/master/huancayo/producto/a"+data[i][4]+".jpg' height='200' width='200'></td></tr>\n";
		          			}
		          			if(data[i][7]>0){
		          				d += "<tr><td width='100px'><img src='https://raw.githubusercontent.com/paolomelgar/ferreboom/master/huancayo/marca/a"+data[i][7]+".jpg' width='100px'></td><td width='100px' style='font-weight:bold;font-size:25px;color:#f63;' class='precio' align='center'>S/ "+data[i][1]+"</td></tr>\n";
		          			}else{
	    ...
	    $('#table').on('click','.buscar',function(){
	    	if(parseInt($(this).parent().parent().parent().find(".cant").val())>0 && parseInt($(this).parent().parent().parent().find(".cant").val())<=parseInt($(this).parent().parent().parent().find(".stock").val())){
	            ...
	            if(i==0){
		    		$('#row').append("<tr class='fila'><td width='2.5%' title='s' height='20px' style='padding:0px;cursor:pointer'><img src='https://raw.githubusercontent.com/paolomelgar/ferreboom/master/huancayo/producto/a"+id+".jpg' width='100%'></td><td style='display:none'>"+id+"</td><td align='right' width='7.5%' contenteditable='true' class='edit'>"+cant+"</td><td width='60%'>"+prod+" "+marca+"</td><td align='right' width='10%'>"+precio+"</td><td align='right' width='15%'>"+total+"</td><td width='5%' align='center'><span class='ui-icon ui-icon-circle-close del' style='cursor:pointer'></td></tr>");
		...
		$('#table').on('click','.img',function(){
			...
			if(parseInt($(this).parent().parent().find('.idmarca').val())>0){
				a="<img src='https://raw.githubusercontent.com/paolomelgar/ferreboom/master/huancayo/marca/a"+$(this).parent().parent().find('.idmarca').val()+".jpg' height='50' width='250'>";
			}else{
				a=$(this).parent().parent().find('.idmarca').val();
			}
            swal({
              title: a,
              text: "<img src='https://raw.githubusercontent.com/paolomelgar/ferreboom/master/huancayo/producto/a"+$(this).parent().parent().find('.ii').attr('id')+".jpg' height='300' width='300'><br><div style='font-size:40px;color:blue;font-weight:bold'>"+$(this).parent().parent().find('.precio').text()+"</div>",   
              html: true,
...
<body style='overflow-y:scroll;background-image:url("http://www.zastavki.com/pictures/originals/2014/Backgrounds_Wooden_floor_082130_.jpg");background-attachment: fixed;'>
	...
	<nav>
		...
		<img src="https://raw.githubusercontent.com/paolomelgar/ferreboom/master/huancayo/logo_ferreboom.png" style='width:12em;left:3em;position:absolute;top:1em'>
		...
		<tr>
			<td align='center' style="max-width:400px;background-size: 100%;" id='back'>
                <ul id="image-gallery" class="gallery list-unstyled cS-hidden" style='margin-top:50px'>
		            ...
		            while($row=mysqli_fetch_assoc($sql)){ ?>
		            	<li data-thumb="https://raw.githubusercontent.com/paolomelgar/ferreboom/master/huancayo/producto/a<?php echo $row['id']; ?>.jpg"> 
		            		<table style='margin-bottom:50px;border-collapse:collapse;border:5px solid black'>
		            			<tr>
		            				<td style='background-color:white;padding:0px'>
			                        	<img width='300px' height='300px' src="https://raw.githubusercontent.com/paolomelgar/ferreboom/master/huancayo/producto/a<?php echo $row['id']; ?>.jpg"/>
			            			</td>
                ...
                <div style='position:absolute;left:70px;top:40px;'>
                	<img src="https://raw.githubusercontent.com/paolomelgar/ferreboom/master/huancayo/logo_ferreboom.png" width='300px'>
	...
	<div id='dialog' style='display:none;'>
		<div align='center'><img id='theImg' src='https://raw.githubusercontent.com/paolomelgar/ferreboom/master/huancayo/logo_ferreboom.png' style='width:25%;height:80px;'></div>
