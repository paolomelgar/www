    ...
    <table width="100%" align="left" id="table" class="table table-bordered table-condensed">
      ...
      <?php 
        while($row=mysqli_fetch_assoc($sql)){
          ...
          $m=mysqli_query($con,"SELECT sum(total) FROM total_ventas WHERE fecha='".$row['fecha']."' AND credito='CONTADO' AND entregado='SI'");
          $ro3=mysqli_fetch_row($m);
          ...
          $egreso=$ro[2]+$ro[3]+$ro1[0]+$ro2[0];
            ...
            <tr style="font-size:12px;font-weight:bold">
              ...
              <td style="text-align:right" width='10%' bgcolor="#d9edf7"><?php echo number_format($ro[0] ,2,".",""); ?></td>
