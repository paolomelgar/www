		...
		$(".selected").each(function(){
			...
			$("#agregardatos").dialog({
				...
				open:function(){
					...
					$('#formagregar input[id="usuario"]').val("aaaaa");
					$('#formagregar input[id="password"]').val("aaaaa");
					$('#formagregar input[id="cumple"]').val(dato2);
					$('#formagregar input[id="celular"]').val(dato3);
