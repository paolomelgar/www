var socket=io.connect('http://ferreboom.ddns.net:3000');
$(function(){
  var date = new Date();
  $('#fechaini').datepicker({
    firstDay:1,
    ...
    if(e.which == 13) {
      ...
      if($('#id').val()>0){
        var next= "<tr class='fila'>\n" +
                  "<td width='2%' style='padding:0px;' title='s'><img src='https://raw.githubusercontent.com/paolomelgar/ferreboom/master/huancayo/producto/a"+$("#id").val()+".jpg?timestamp=23124' width='100%' height='100%' class='img'></td>\n"+
      ...
      success: function(data){
        ...
        switch(comprobante){
          case 'BOLETA DE VENTA':
            $('#dx').append("<table width='50%' style='margin-top:125px;font:0.8em Verdana;'><tr><td width='4%'>&nbsp</td><td width='96%'>"+data[1][12]+"</td></tr></table>\n"+
              "<table width='50%' style='margin-top:-3px;font:0.8em Verdana;'><tr><td width='4%'>&nbsp</td><td width='96%'>"+data[1][1]+"</td></tr></table>\n"+
              "<table width='50%' style='margin-top:-3px;font:0.8em Verdana;'><tr><td width='8%'>&nbsp</td><td width='92%'>"+data[1][2]+"</td></tr></table>\n"+
              "<table width='50%' style='margin-bottom:-4px;margin-top:-5px'><tr><td width='5%' align='center'>&nbsp</td><td width='75%' align='center'></td><td width='10%' align='center'>&nbsp</td><td width='10%' align='center'>&nbsp</td></tr></table>\n"
            );
            for (var i=0;i<data[0].length;i++) {
              $('#dx').append("<table width='47%' style='margin-top:-8px;font:0.6em Verdana;margin-left:-10px'><tr height='32px'><td width='4%'>"+data[0][i][1]+"&nbsp</td><td width='67%' style='line-height:12px'>"+data[0][i][0]+"</td><td width='8%' align='right'>"+data[0][i][2]+"</td><td width='21%' align='right'>"+data[0][i][3]+"</td></tr></table>");
            }
            while(v1<12-parseInt(data[0].length)){
              $('#dx').append("<table width='50%' style='margin-top:-8px'><tr height='32px'><td>&nbsp</td></tr></table>");
              v1++;
            }
            $('#dx').append("<table width='46%' style='font:0.8em Verdana;margin-top:6px'><tr><td width='90%' align='right'>&nbsp</td><td align='right' width='10%'>"+data[1][3]+"</td></tr></table></div>");
          ...
          
          case 'FACTURA PAOLA':
            $('#dx').append("<table width='100%' style='margin-top:158px;font:0.8em arial;'><tr><td width='6%'>&nbsp</td><td width='6%'>"+data[1][12].slice(0,2)+"</td><td width='10%'>"+data[1][12].slice(3,5)+"</td><td width='78%'>"+data[1][12].slice(9,10)+"</td></tr></table>\n"+
            ...
            for (var i=0;i<data[0].length;i++) {
              $('#dx').append("<table width='100%' style='margin-top:-5px;font:0.7em arial'><tr height='22px'><td width='6%' align='right'>"+data[0][i][1]+"</td><td <td width='3%'></td><td width='61%'>"+data[0][i][0]+"</td><td width='9%' align='right'>UND</td><td width='9%' align='right'>"+data[0][i][2]+"</td><td width='12%' align='right'>"+data[0][i][3]+"</td></tr></table>");
            }
            while(v1<21-parseInt(data[0].length)){
            ...
            $("#dx").append("<table width='100%' style='font:0.8em arial;margin-top:10px;'><tr><td width='6%'>&nbsp</td><td width='74%' id='let'></td><td width='10%'>&nbsp</td><td align='right' width='10%'>"+subigv1+"</td></tr></table>\n"+
          ...
          
          case 'PROFORMA':
            $('#dx').append("<table width='50%' style='margin-top:130px;font:0.8em Verdana;'><tr><td width='4%'>&nbsp</td><td width='96%'>"+data[1][12]+"</td></tr></table>\n"+
              "<table width='50%' style='margin-top:-3px;font:0.8em Verdana;'><tr><td width='4%'>&nbsp</td><td width='96%'>"+data[1][1]+"</td></tr></table>\n"+
              "<table width='50%' style='margin-top:-3px;font:0.8em Verdana;'><tr><td width='8%'>&nbsp</td><td width='92%'>"+data[1][2]+"</td></tr></table>\n"+
              "<table width='50%' style='margin-bottom:-4px;margin-top:-5px'><tr><td width='5%' align='center'>&nbsp</td><td width='75%' align='center'></td><td width='10%' align='center'>&nbsp</td><td width='10%' align='center'>&nbsp</td></tr></table>\n"
            );
          ...
          case 'GUIA DE REMISION':
            $('#dx').append("<table width='100%' style='margin-top:141px;font:0.8em arial;'><tr><td width='10%'>&nbsp</td><td width='6%'>"+data[1][12].slice(0,2)+"</td><td width='6%'>"+data[1][12].slice(3,5)+"</td><td width='6%'>"+data[1][12].slice(6,10)+"</td><td width='14%'>&nbsp</td><td width='5%'>"+data[1][12].slice(0,2)+"</td><td width='6%'>"+data[1][12].slice(3,5)+"</td><td width='6%'>"+data[1][12].slice(6,10)+"</td><td width='41%'></td></tr></table>\n"+
              "<table width='100%' style='margin-top:15px;font:0.8em arial;'><tr><td width='2%'>&nbsp</td><td width='50%'>PROL. HUANUCO N° 272 - HUANCAYO - HUANCAYO - JUNIN</td><td width='1%'>&nbsp</td><td width='47%'>"+data[1][2]+"</td></tr></table>\n"+
              "<table width='100%' style='margin-top:38px;font:0.8em arial;'><tr><td width='2%'>&nbsp</td><td width='50%'>"+data[1][1]+"</td><td width='48%'>&nbsp</td></tr></table>\n"+
              ...
              "<table width='100%' style='margin-bottom:-4px;margin-top:0px'><tr><td width='5%' align='center'>&nbsp</td><td width='75%' align='center'>&nbsp</td><td width='10%' align='center'>&nbsp</td><td width='10%' align='center'>&nbsp</td></tr></table>\n"
            );
            for (var i=0;i<data[0].length;i++) {
              $('#dx').append("<table width='100%' style='margin-top:-5px;font:0.7em arial'><tr height='22px'><td width='6%'>&nbsp</td><td width='5%' align='right'>"+data[0][i][1]+"</td><td width='68%'>&nbsp&nbsp&nbsp&nbsp&nbsp"+data[0][i][0]+"&nbsp&nbsp</td><td width='10%' align='right'>&nbspUND</td><td width='11%'></td></tr></table>");
            }
  ...
  $('#estado').on('click',function(e){
    if(e.offsetY < 0){
      if($('#id1').val()>0 && $('#estado').val()!=""){
        $('#row1').append(
          "<tr class='fila'>\n" +
          "  <td width='2%' style='padding:0px;' title='s'><img src='https://raw.githubusercontent.com/paolomelgar/ferreboom/master/huancayo/producto/a"+$("#id1").val()+".jpg?timestamp=23124' width='100%' height='100%'></td>\n"+
          ...
          click: function() { 
            $.ajax({
              ...
              success: function(data){
                ...
                for (var i=0;i<data[0].length;i++) {
                  var next= "<tr class='fila'>\n" +
                            "<td width='2%' style='padding:0px;' title='s'><img src='https://raw.githubusercontent.com/paolomelgar/ferreboom/master/huancayo/producto/a"+data[0][i][4]+".jpg?timestamp=23124' width='100%' height='100%'></td>\n"+
                ...
                for (var i=0;i<data[2].length;i++) {
                  ...
                  $('#row1').append(
                    "<tr class='fila'>\n" +
                    "<td width='2%' style='padding:0px;' title='s'><img src='https://raw.githubusercontent.com/paolomelgar/ferreboom/master/huancayo/producto/a"+data[2][i][4]+".jpg?timestamp=23124' width='100%' height='100%'></td>\n"+
          ...
          switch($('#documento').val()){
            ...
            case 'GUIA DE REMISION':
              ...
              $(this).append("<div id='xd' align='center'><table width='100%' style='margin-top:0px;font:1.0em Verdana;'><tr><td width='10%'>&nbsp</td><td width='10%'>"+$('#fecha').val()+"</td><td width='20%'>&nbsp</td><td width='10%'>"+$('#fecha').val()+"</td><td width='50%'>&nbsp</td></tr></table>\n"+
                "<table width='100%' style='margin-top:7px;font:1.0em Verdana;'><tr><td width='3%'>&nbsp</td><td width='40%' align='center'>JR. huancayo N° 959</td><td width='10%'>&nbsp</td><td width='47%' align='center'>"+arr[0]+"</td></tr></table>\n"+
                "<table width='100%' style='margin-top:-3px;font:1.0em Verdana;'><tr><td width='5%'>&nbsp</td><td width='10%'>huancayo</td><td width='5%'>&nbsp</td><td width='10%'>huancayo</td><td width='5%'>&nbsp</td><td width='10%'>huancayo</td><td width='15%'>&nbsp</td><td width='10%'>"+arr[3]+"</td><td width='5%'>&nbsp</td><td width='10%'>"+arr[2]+"</td><td width='5%'>&nbsp</td><td width='10%'>"+arr[1]+"</td></tr></table>\n"+
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  $('#documento').change(function(){
    ...
    if($('#documento').val()=='NOTA DE PEDIDO'){
      ...
      $('#form select[name="forma-pago"]').val('CONTADO').change();
      $('#form select[name="entregar"]').val('SI');
