...
require_once('../connection.php');
    ...
    else if($_POST['change']=='CONTABLE PAOLA'){$query.=" AND documento='FACTURA PAOLA'";}
    else{$query.=" AND documento='FACTURA DORIS'";}
    ...
    <table width='98%' id="venta" style="border-collapse: collapse;" align='center'>
      ...
      <?php 
        ...
        <tr style="font-size:12px;font-weight:bold">
          ...
          <?php }else{ ?>
          <td style="border: 1px solid black;text-align:right" width='10%'><?php echo $row['unitario']*$row['cambio']; ?></td>
          <td style="border: 1px solid black;text-align:right" width='10%'><?php echo $row['importe']*$row['cambio']; ?></td>
          <?php } ?>
        </tr>
        <?php
        $n++;
