...
<body>
	...
	<form name="formagregar" id="formagregar">
		<table width='100%'>
			...
			<tr><td width='25%'>RUC:</td><td width='75%'><input type="text" name="ruc" id="ruc" class="span3" maxlength='11' style="text-transform:uppercase;float:left;"/></td></tr>
			<tr><td width='25%'>TRANSPORTISTA:</td width='75%'><td><input type="text" name="transportista" id="transportista" class="span3" style="text-transform:uppercase;float:left;"/></td></tr>
			...
			<tr><td width='25%'>REPRESENTANTE:</td width='75%'><td><input type="text" name="representante" id="representante" class="span3" style="text-transform:uppercase;float:left;"/></td></tr>
			<tr><td width='25%'>TELEFONO:</td><td width='75%'><input type="text" name="telefono" id="telefono" class="span3" style="text-transform:uppercase;float:left;"/></td></tr>
			<tr><td width='25%'>CELULAR:</td><td width='75%'><input type="text" name="celular" id="celular" class="span3" style="text-transform:uppercase;float:left;"/></td></tr>
	...
	<div id="body">
		<h3 style="text-align: center;color:#428bca;margin-top:-2px;font-weight:bold">REGISTRO DE TRANSPORTISTAS</h3>
		<div id="boton">
			RUC/TRANSPORTISTA:<input type="text" id="busqueda" name="busqueda" class="span6" placeholder="Realize su Busqueda..." style="text-transform:uppercase;margin-right:10px" autocomplete="off"/>
		...
		<table class="table table-bordered">
	        ...
	        <tr>
	          <td colspan='14'>
	            ...
	            <div style="float:right;margin-top:5px;">Total de Transportistas Registrados:   </div>
	          </td>
	        <tr>
	      </tfoot>
		</table> 
