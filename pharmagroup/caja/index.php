...
<?php 
session_start();
if($_SESSION['valida']=='pharmagroup' && $_SESSION['cargo']!='VENDEDOR' ){
?>
<html>
<head>
  <title>CAJA</title>
...
<body>
  <form id="form" name="form" action="" method="post" autocomplete="off">
    ...
    <audio id="sound"><source src="notificacion.mp3"></source></audio>
        ...
        <tr>
          ...
          <td width='17%'>
            ...
            <select class='span2' id="forma-pago" name="forma-pago" style='margin-bottom: 0px;'>
              ...
              <option value="LETRA" style="display:none">LETRA</option>
