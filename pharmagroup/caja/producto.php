...
require_once('../connection.php');
  if(isset($_POST) && !empty($_POST)){
    ...
    if($_POST['doc']=='FACTURA ELECTRONICA INNOVA' || $_POST['doc']=='FACTURA ELECTRONICA BOOM'){
    ...
    ?>
      <tr class="tr" bgcolor='white' <?php if($row['stock_real']<=0 && $_POST['doc']!='FACTURA ELECTRONICA INNOVA' && $_POST['doc']!='FACTURA ELECTRONICA BOOM'){echo "style='font-weight:bold;background-color:#FF9D9D;'";}else{echo "style='font-weight:bold;'";} ?>>
        ...
        <?php if($_POST['doc']=='FACTURA ELECTRONICA INNOVA'){ ?>
        <td style='color:blue;text-align:right'><?php echo $row['stock_con']; ?></td>
        <?php }else if($_POST['doc']=='FACTURA ELECTRONICA BOOM'){ ?>
