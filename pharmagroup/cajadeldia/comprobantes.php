  ...
  <div style="overflow:auto;height:100%;align:center">
    <table width="100%" cellpadding="0" cellspacing="0" border="1" align="center" id='filter1'>
      ...
      <tbody id="verbody">
       ...
       <tfoot>
        <tr style="font-size:12px;font-weight:bold">
          <td width='80%' style="text-align:right" colspan='4'>TOTAL</td>
          <td width='10%' style="text-align:right" id='sumatotal'></td>
          <td width='10%'></td>
        </tr>
       </tfoot>
      </table>
