...
<?php 
session_start();
if($_SESSION['valida']=='pharmagroup' && $_SESSION['cargo']=='ADMIN' || $_SESSION['cargo']=='ENCARGADOTIENDA' || $_SESSION['cargo']=='LOGISTICA' || $_SESSION['cargo']=='FRANQUICIA' || $_SESSION['cargo']=='ASISTENTE'){
?>
<html>
<head>
  <title>COMPRAS</title>
