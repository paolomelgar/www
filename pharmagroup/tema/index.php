    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                $q=mysqli_query($con,"SELECT * FROM producto WHERE activo='SI' AND foto='SI' ORDER BY id ASC LIMIT 60");
                while ($row=mysqli_fetch_assoc($q)){
                        ?>
                        <div class="col-sm-3 col-lg-3 col-md-3">
                        <div class="thumbnail">
                            <?php echo "<img src='../fotos/a".$row['id'].".jpg' alt=''>"; ?>
                            <div class="caption">
                                <h4 class="pull-right"></h4>
                                <h4><a>S/. <?php echo $row['p_unidad']; ?></a>
                                </h4>
