...
<body>
	...
	<form name="formagregar" id="formagregar">
		<table width='100%'>
			...
			<tr><td>UBICACION:</td><td><input type="text" name="ubicacion" id="ubicacion" class="span3" style="text-transform:uppercase;float:left;"/></td></tr>
	...
	<div id="boton">
		UBICACION:<input type="text" id="busqueda" name="busqueda" class="span6" placeholder="Realize su Busqueda..." style="text-transform:uppercase;margin-right:10px"/>
	...
	<table class="table table-bordered">
		<thead>
			<tr style='background-color:#428bca;color:white'>
				<th style="text-align: center;width:90%">UBICACION</th>
      	...
      	<tfoot id='foot'>
	        <tr>
	          <td colspan='13'>
	            ...
	            <div style="float:right;">Total de Ubicaciones Registradas:   </div>
	          </td>
	        <tr>
	    </tfoot>
	</table> 
