    ...
    $.ajax({
      ...
      success: function(data){
        ...
        if(parseFloat(data[1][4])!=0){
          ...
          $('#dx').append("<table width='80%' align='center' style='margin-top:-5px;font:0.8em Verdana;'><tr><td>.</td><td colspan='3' width='90%' align='right'>DEVOLUCION</td><td align='right'>"+data[1][4]+"</td></tr></table>");
        }
        ...
        if(data[1][10]>0){
          $('#dx').append("<table width='80%' align='center' style='margin-top:-5px;font:0.8em Verdana;'><tr><td>.</td><td colspan='3' width='90%' align='right'>A/C.</td><td align='right'>"+data[1][10]+"</td></tr></table>");
          var resta1=parseFloat(data[1][5]-data[1][10]).toFixed(2);
          $('#dx').append("<table width='80%' align='center' style='margin-top:-5px;font:0.8em Verdana;'><tr><td>.</td><td colspan='3' width='90%' align='right'>RESTA</td><td align='right'>"+resta1+"</td></tr></table></div>");
        }
