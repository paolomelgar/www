...
if(isset($_POST['accion']) && !empty($_POST['accion'])){
    switch ($_POST['accion']) {
        case 'add':
            ...
            move_uploaded_file($_FILES['imagen']['tmp_name'], realpath("C:/Users/Desktop/Documents/GitHub/ferreboom/huancayo/marca ")."/a".$ro[0].".jpg");
    	break;
    	...
    	case 'edit':
            ...
            move_uploaded_file($_FILES['imagen']['tmp_name'], realpath("C:/Users/Desktop/Documents/GitHub/ferreboom/huancayo/marca ")."/a".$_POST['id'].".jpg");
   		break;
    	...
    	case 'del':
            ...
            if(mysqli_num_rows($sqll)>0){
                unlink("C:/Users/Desktop/Public/huancayo/marca"."/a".$_POST['id'].".jpg");
            }
