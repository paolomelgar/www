...
require_once('../connection.php');
  ...
  while($row=mysqli_fetch_assoc($sql)){
    ...
    <?php }else{ ?>
      <div style='text-align:right;width:200px;margin-left:80px;margin-top:2px;cursor:pointer;'><div style='border:1px solid #B3CED9;font-size:14px;word-wrap:break-word;display:inline-block;background-color:#D9FDFF;padding: 5px 8px 4px;border-radius: 5px ;' title='<?php echo $row['fecha']; ?>'><?php echo $row['mensaje']; ?></div></div>
    <?php }
  }
?>