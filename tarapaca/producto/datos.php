...
}else if($_POST['cont']=='DORIS'){
    $producto.=" AND stock_con1>0";
}
if($_POST['prov']!=""){
...
while($row=mysqli_fetch_assoc($result)){ ?>  
    <tr class="tr">
        ...
        <td style='padding:0px' align='center' title='a'><?php echo '<img src="https://raw.githubusercontent.com/paolomelgar/ferreboom/master/huancayo/producto/a'.$row['id'].'.jpg?timestamp=41232" height="100%" width="100%">'; ?></td>
        ...
        <td class="text" style="text-align:right;color:red;font-weight:bold"><?php echo $row['stock_real']; ?></td>
        ...
        <td class="text" style="text-align:right;color:green;font-weight:bold"><?php echo $row['p_compra']; ?></td>
        <?php }else{ ?>
