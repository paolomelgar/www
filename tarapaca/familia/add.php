...
if(isset($_POST['accion']) && !empty($_POST['accion'])){
    switch ($_POST['accion']) {
        case 'add':
            ...
            move_uploaded_file($_FILES['imagen']['tmp_name'], realpath("C:/Users/Desktop/Documents/GitHub/ferreboom/huancayo/familia ")."/a".$ro[0].".jpg");
        break;
        ///////////////////////////////////////////////////////////////////////////////////
        case 'edit':
            if($_FILES['imagen']['tmp_name']!=''){
            ...
            move_uploaded_file($_FILES['imagen']['tmp_name'], realpath("C:/Users/Desktop/Documents/GitHub/ferreboom/huancayo/familia ")."/a".$_POST['id'].".jpg");
        break;
        ///////////////////////////////////////////////////////////////////////////////////
        case 'del':
            $sqll = mysqli_query($con,"SELECT * FROM familia WHERE foto='SI' AND id='".$_POST['id']."'");
            if(mysqli_num_rows($sqll)>0){
                unlink("C:/Users/Desktop/Documents/GitHub/ferreboom/huancayo/familia"."/a".$_POST['id'].".jpg");
            }
