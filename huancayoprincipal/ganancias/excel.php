...
while($row=mysqli_fetch_assoc($sql)){
    ...
    if($r1[1]>0){
        ...
        $output.="<tr><td>".$row['producto']."</td><td>".$row['marca']."</td><td>".$row['familia']."</td><td>".$r1[0]."</td><td>".$r1[1]."</td><td>".$r1[2]."</td><td>".($r1[2]-$r1[1])."</td><td>".$x."%</td><td>".$row['cant_caja']."</td><td>".$row['stock_real']."</td><td>".$row['proveedor']."</td><td>".$row['p_compra']."</td><td>".$row['p_mayor']."</td><td>".$row['p_promotor']."</td><td>".$row['ubicacion']."</td></tr>";
    }else{
        $output.="<tr><td>".$row['producto']."</td><td>".$row['marca']."</td><td>".$row['familia']."</td><td>0</td><td>0</td><td>0</td><td>0</td><td>0%</td><td>".$row['cant_caja']."</td><td>".$row['stock_real']."</td><td>".$row['proveedor']."</td><td>".$row['p_compra']."</td><td>".$row['p_mayor']."</td><td>".$row['p_promotor']."</td><td>".$row['ubicacion']."</td></tr>";
    }
}
$output.="</table>";
echo $output;
