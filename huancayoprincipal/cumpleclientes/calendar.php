    ...
    while ( $day_num <= $days_in_month ) {
        ...
        if(mysqli_num_rows($sql)>0){
            ...
            while($row = mysqli_fetch_assoc($sql)){
                    ...
                    $montos.="<div style='color:blue;text-decoration: ;margin-bottom:-12px;cursor:pointer;' title='".$row['cliente']."' class='cliente' id='".$row['id_cliente']."'>".substr($row['cliente'],0,28)." </div><br>";
