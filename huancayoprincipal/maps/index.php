...
<head>
	...
	function initialize() {
		var mapProp = {
		  center:new google.maps.LatLng(-12.0696667,-75.2066667),
		  zoom:15,
		...
		map=new google.maps.Map(document.getElementById("googleMap"),
			mapProp);
		<?php 
            $q=mysqli_query($con,"SELECT cliente,latitud,longitud FROM cliente WHERE latitud!='' AND longitud!=''");
            ...
            ?>
				...
				marker['infowindow'] = new google.maps.InfoWindow({
		            content: "<?php echo htmlentities($row['cliente']); ?>",
		        });
...
<body>
	<div id='ferreteria' style='position:fixed;z-index:1000;margin-left:100px'>
		<tr>
			...
			<td>PROMOTOR: 
				<?php 
                $q=mysqli_query($con,"SELECT * FROM usuario WHERE activo='SI' AND cargo='PROMOTOR' OR cargo='ADMIN'");
                        ?>
