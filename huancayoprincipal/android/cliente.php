...
require_once('../connection.php');
  ...
  $query = "SELECT ruc,cliente,direccion,telefono,representante,id_cliente FROM cliente WHERE $producto AND tipo='FERRETERIA' AND activo!='ANULADO' ORDER BY cliente LIMIT 10";
