...
<body>
	...
	<div id="body">
		<h3 style="text-align: center;margin-bottom:-10px;margin-top:-2px">REGISTRO DE PROVEEDORES</h3>
	<div id="boton">
		RUC/PROVEEDOR:<input type="text" id="busqueda" name="busqueda" class="span6" placeholder="Realize su Busqueda..." style="text-transform:uppercase;margin-right:10px"/>
	...
	<table class="table table-bordered">
		<thead>
			<tr style='background-color:#428bca;color:white'>
				...
				<th style="text-align: center;width:26%">PROVEEDOR</th>
      	...
      	<tfoot id='foot'>
	        <tr>
	          <td colspan='13'>
	            ...
	            <div style="float:right;">Total de Proveedores Registrados:   </div>
	          </td>
	        <tr>
	    </tfoot>
	</table> 
