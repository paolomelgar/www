      ...
      <table align="center" width="98%" >
        <thead>
          ...
          <tr>
            ...
            <td align='right'><input type="text" id="importe" style="text-align:right;background-color: #F8FD8D" class='span1'/><input type='hidden' id='compra'><input type='hidden' id='ubic'><input type='hidden' id='caja'></td>
          </tr>
        </thead>
        <tbody>
          <tr>
