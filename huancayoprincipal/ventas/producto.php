  ...
  if(isset($_POST) && !empty($_POST)){
    ...
    ?>
      <tr class="tr" <?php echo $as; ?> style='font-weight:bold;'>
        <td style='padding:0px;' title='s'><?php echo '<img src="https://raw.githubusercontent.com/paolomelgar/www/master/innova/a'.$row['id'].'.jpg?timestamp=23124" width="100%" height="100%">'; ?></td>
