...
<body>
	...
	<form name="formagregar" id="formagregar">
		<table width='100%'>
			...
			<tr><td>TRANSPORTISTA:</td><td><input type="text" name="transportista" id="transportista" class="span3" style="text-transform:uppercase;float:left;"/></td></tr>
			...
			<tr><td>REPRESENTANTE:</td><td><input type="text" name="representante" id="representante" class="span3" style="text-transform:uppercase;float:left;"/></td></tr>
			<tr><td>TELEFONO:</td><td><input type="text" name="telefono" id="telefono" maxlength='9' class="span3" style="text-transform:uppercase;float:left;"/></td></tr>
			<tr><td>CELULAR:</td><td><input type="text" name="celular" id="celular" maxlength='9' class="span3" style="text-transform:uppercase;float:left;"/></td></tr>
			<tr><td>E-MAIL:</td><td><input type="text" name="mail" id="mail" maxlength='9' class="span3" style="text-transform:lowercase;float:left;"/></td></tr>
	...
	<div id="body">
		<h3 style="text-align: center;margin-bottom:-10px;margin-top:-2px">REGISTRO DE TRANSPORTISTA</h3>
	<div id="boton">
		RUC/TRANSPORTISTA:<input type="text" id="busqueda" name="busqueda" class="span6" placeholder="Realize su Busqueda..." style="text-transform:uppercase;margin-right:10px"/>
	...
	<table class="table table-bordered">
		<thead>
			<tr style='background-color:#428bca;color:white'>
				...
				<th style="text-align: center;width:5%">TELEFONO</th>
      	...
      	<tfoot id='foot'>
	        <tr>
	          <td colspan='13'>
	            ...
	            <div style="float:right;">Total de Transportistas Registrados:   </div>
	          </td>
	        <tr>
	    </tfoot>
	</table> 
