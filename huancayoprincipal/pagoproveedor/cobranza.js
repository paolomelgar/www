            ...
            success: function(data){
              ...
              for (var i=0;i<data.length;i++) {
                $('#letras1').append(
                  ...
                  "<input type='text' class='monto' value='"+data[i][0]+"' style='text-align:right;width:120px' readonly='readonly'>&nbsp<input type='text' class='fech' value='"+data[i][1]+"' style='text-align:right;width:120px' readonly='readonly'>&nbsp<input type='text' class='unicoo' value='"+data[i][4]+"' style='width:120px;text-align:center' readonly='readonly'>&nbsp<select id='operacion' class='mediopago' style='margin-bottom: 0px;'><option id='EFECTIVO'>EFECTIVO</option><option id='TARJETA'>TARJETA</option></select>&nbsp<input  style='text-align:right;width:120px' type='text' class='real'>&nbsp<input  style='text-align:right;width:120px' type='text' class='fechapagoo'><input type='hidden' class='idd' value='"+data[i][3]+"' style='width:120px;text-align:center' readonly='readonly'>\n" +
                  "</div>\n"
                );
