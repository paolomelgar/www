<?php
  ...
  $hoy=date("Y-m-d");
  if($_POST['str'][6]['value'] !='' AND $_POST['str'][9]['value']!=''){
        $cons=mysqli_query($con,"SELECT * FROM proveedor WHERE ruc='".$_POST['str'][6]['value']."' AND proveedor='".$_POST['str'][9]['value']."'");
    ...
    case 'FACTURA PAUL':
        ...
        if(isset($_POST['producto']) && !empty($_POST['producto'])){
            for ($i=0; $i<sizeof($_POST['producto']) ; $i++) {
                $sql= mysqli_query($con,"INSERT INTO compras (serie,numero,value,documento,producto,cantidad,unitario,importe,idproducto,billete,cambio,proveedor,fecha,hora,entregado) 
                ...
                if($_POST['str'][11]['value']=='SI'){
                    if($_POST['str'][7]['value']=='SOLES'){
                        $inse=mysqli_query($con,"UPDATE producto SET stock_real=(stock_real+".$_POST['cantidad'][$i]."),stock_con=(stock_con+".$_POST['cantidad'][$i]."),p_compra=(".$_POST['unitario'][$i]."),activo='SI' WHERE id='".$_POST['id'][$i]."'");
                    }
                    else{
                        $inse=mysqli_query($con,"UPDATE producto SET stock_real=(stock_real+".$_POST['cantidad'][$i]."),stock_con=(stock_con+".$_POST['cantidad'][$i]."),p_compra=(".$_POST['unitario'][$i]*$_POST['str'][8]['value']."),activo='SI' WHERE id='".$_POST['id'][$i]."'");
                    }
                }
                else{
        ...
        $query= mysqli_query($con,"INSERT INTO total_compras (serie,numero,value,fechafactura,hora,documento,ruc,proveedor,direccion,entregado,subtotal,igv,total,percepcion,montototal,comentario,credito,fechapago,fechaingreso,billete,cambio,pendiente,acuenta,letra) 
                    VALUES ('".$_POST['str'][1]['value']."',
                            '".$_POST['str'][2]['value']."',
                            '".$num."',
                            ...
                            '".$_POST['str'][15]['value']."',
                            '".$_POST['str'][3]['value']."',
                            '".date('Y-m-d', strtotime(str_replace('/', '-', $_POST['str'][4]['value'])))."',
                            NOW(),
                            '".$_POST['str'][7]['value']."',
                            '".$_POST['str'][8]['value']."',
                            '".$pendiente."',
        ...
        if($_POST['str'][11]['value']=='SI' && $_POST['str'][3]['value']=='CONTADO'){
            if($_POST['str'][7]['value']=='SOLES'){
                $am=$_POST['str'][14]['value'];
                $inser=mysqli_query($con,"UPDATE cajamayor SET contados=(contados+round($am,1)) WHERE fecha='$hoy'");
            }
            else{
                $am=$_POST['str'][14]['value']*$_POST['str'][8]['value'];
                $inser=mysqli_query($con,"UPDATE cajamayor SET contados=(contados+round($am,1)) WHERE fecha='$hoy'");
            }
        }
    break;
    case 'FACTURA BOOM':
        ...
        if(isset($_POST['producto']) && !empty($_POST['producto'])){
            for ($i=0; $i<sizeof($_POST['producto']) ; $i++) {
                ...
                if($_POST['str'][11]['value']=='SI'){
                    if($_POST['str'][7]['value']=='SOLES'){
                        $inse=mysqli_query($con,"UPDATE producto SET stock_real=(stock_real+".$_POST['cantidad'][$i]."),stock_con1=(stock_con1+".$_POST['cantidad'][$i]."),p_compra=(".$_POST['unitario'][$i]."),activo='SI' WHERE id='".$_POST['id'][$i]."'");
                    }
                    else{
                        $inse=mysqli_query($con,"UPDATE producto SET stock_real=(stock_real+".$_POST['cantidad'][$i]."),stock_con1=(stock_con1+".$_POST['cantidad'][$i]."),p_compra=(".$_POST['unitario'][$i]*$_POST['str'][8]['value']."),activo='SI' WHERE id='".$_POST['id'][$i]."'");
                    }
                }
                else{
	...
	case 'NOTA DE PEDIDO':
        ...
        if(isset($_POST['producto']) && !empty($_POST['producto'])){
            for ($i=0; $i<sizeof($_POST['producto']) ; $i++) {
                ...
                if($_POST['str'][11]['value']=='SI'){
                    if($_POST['str'][7]['value']=='SOLES'){
                        $inse=mysqli_query($con,"UPDATE producto SET stock_real=(stock_real+".$_POST['cantidad'][$i]."),p_compra=(".$_POST['unitario'][$i]."),activo='SI' WHERE id='".$_POST['id'][$i]."'");
                    }
                    else{
                        $inse=mysqli_query($con,"UPDATE producto SET stock_real=(stock_real+".$_POST['cantidad'][$i]."),p_compra=(".$_POST['unitario'][$i]*$_POST['str'][8]['value']."),activo='SI' WHERE id='".$_POST['id'][$i]."'");
                    }
                }else{
                    if($_POST['str'][7]['value']=='SOLES'){
                        ...
                        $inse=mysqli_query($con,"UPDATE producto SET p_compra=(".$_POST['unitario'][$i]*$_POST['str'][8]['value'].") WHERE id='".$_POST['id'][$i]."'");
                    }
                }
            }
        }
