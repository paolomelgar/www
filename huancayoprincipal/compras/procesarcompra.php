            ...
            for ($i=0; $i<sizeof($_POST['producto']) ; $i++) {
                ...
                if($_POST['str'][11]['value']=='SI'){
                    if($_POST['str'][7]['value']=='SOLES'){
                        ...
                        $inse=mysqli_query($con,"UPDATE producto SET stock_real=(stock_real+".$_POST['cantidad'][$i]."),stock_con1=(stock_con1+".$_POST['cantidad'][$i]."),p_compra=(".$_POST['unitario'][$i]*$_POST['str'][8]['value']."),activo='SI',antiguedad=NOW() WHERE id='".$_POST['id'][$i]."'");
                    }
                }
                else{
            ...
            for ($i=0; $i<sizeof($_POST['producto']) ; $i++) {
                ...
                if($_POST['str'][11]['value']=='SI'){
                    if($_POST['str'][7]['value']=='SOLES'){
                        ...
                        $inse=mysqli_query($con,"UPDATE producto SET stock_real=(stock_real+".$_POST['cantidad'][$i]."),p_compra=(".$_POST['unitario'][$i]*$_POST['str'][8]['value']."),activo='SI',antiguedad=NOW() WHERE id='".$_POST['id'][$i]."'");
                    }
                }else{
                    if($_POST['str'][7]['value']=='SOLES'){
