...
//////////////////////////////////////////////////////////////////////////////////////////////////////////// 
  $("#sunat").click(function(){
    ...
    $('#dialogsunat').append("<iframe src='http://www.sunat.gob.pe/cl-ti-itmrconsruc/jcrS03Alias' width='100%' height='98%' id='frameDemo'></iframe><span class='ui-icon ui-icon-circle-close' id='sal' style='position:absolute;right:0px;top:0px;cursor:pointer'>");
    $('#sal').click(function(){
      $('#dialogsunat').hide();
    });
  });
